...
const CHERNOBOG_CORE_MODEL_URL = "/models/chernobog/chernobog-core-3d7k-restpose-seamless.glb";
...
function BespokeChernobogCore({
  ...
  useEffect(() => {
    idlePerformanceNodesRef.current = {
      pupil: model.getObjectByName("PIVOT_Pupil") ?? null,
      iris: model.getObjectByName("PIVOT_Iris") ?? null,
      orbit: model.getObjectByName("PIVOT_OrbitSystem") ?? null,
      energy: model.getObjectByName("EnergyCore") ?? null,
    };
