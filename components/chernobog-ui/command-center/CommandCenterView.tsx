import CoreEye from "@/components/command/CoreEye";
          ...
          <div className="grid gap-4 p-4 xl:grid-cols-[295px_minmax(0,1fr)_365px]">
            ...
            <div className="space-y-4">
              <CoreEye
                ...
                statusLabel="SIGNAL STATE: LOCKED"
                body="Chernobog command center is the operational home surface. Live directives remain in the command console; this chamber exposes subsystem launch, route state, vault presence, and review telemetry."
              />
