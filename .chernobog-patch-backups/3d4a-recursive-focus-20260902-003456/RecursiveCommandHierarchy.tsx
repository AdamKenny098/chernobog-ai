...
function FloatingExecutive({
  ...
  return (
    <div className="group relative flex h-[300px] w-[300px] items-center justify-center">
      ...
      />
      <div className="relative flex h-24 w-24 items-center justify-center rounded-full border border-[#a75b28]/55 bg-[#080402] text-[10px] font-semibold uppercase tracking-[0.18em] text-[#e6a35f] shadow-[0_0_32px_rgba(255,113,24,0.1)]">
        {node.kind === "agent" ? "Agent" : "Exec"}
      </div>
